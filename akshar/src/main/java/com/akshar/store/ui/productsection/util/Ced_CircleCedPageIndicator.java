...
package com.akshar.store.ui.productsection.util;
 ...
 */
public class Ced_CircleCedPageIndicator extends View implements Ced_PageIndicator {
    ...
    public Ced_CircleCedPageIndicator(Context context) {
        this(context, null);
    }

    public Ced_CircleCedPageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.vpiCirclePageIndicatorStyle);
    }

    public Ced_CircleCedPageIndicator(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        if (isInEditMode()) return;

        //Load defaults from resources
        final Resources res = getResources();
        final int defaultPageColor = res.getColor(R.color.ebebebe);
        //default_circle_indicator_fill_color
        final int defaultFillColor = res.getColor(R.color.AppTheme);
        final int defaultOrientation = res.getInteger(R.integer.default_circle_indicator_orientation);
        final int defaultStrokeColor = res.getColor(R.color.ebebebe);
