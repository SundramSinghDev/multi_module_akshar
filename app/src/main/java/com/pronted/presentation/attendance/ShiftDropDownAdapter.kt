...
class ShiftDropDownAdapter(private val itemClickListener: ItemClickListener<ShiftResponseModel>) :
    RecyclerView.Adapter<ShiftDropDownAdapter.ChildViewHolder>() {

    var list = listOf<ShiftResponseModel>()
    ...
    inner class ChildViewHolder(
         ...
         * Bind data
         *
         * @param shiftResponseModel
         */
        fun bindData(shiftResponseModel: ShiftResponseModel) {
            binding.run {
                tvName.text = shiftResponseModel.name
            }
        }
    }
}