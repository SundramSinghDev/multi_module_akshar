...
import com.pronted.databinding.RowSeeAllBirthdayBinding
...
class BirthdaysPagerAdapter(
    private val mContext: Context,
    private val tabPage: Int
) : RecyclerView.Adapter<BirthdaysPagerAdapter.ChildViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChildViewHolder {
        return ChildViewHolder(
            parent.context,
            RowSeeAllBirthdayBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        )
    }
        ...
        holder.binding.run {
            ...
            if (model.imageUrl.isNullOrBlank()) {
                ...
                if (model.lastName.isNullOrBlank()) {
                    ...
                    "${model.firstName?.substring(0, 1)?.uppercase()}${
     ...
     * @property binding
     */
    class ChildViewHolder(private val context: Context, val binding: RowSeeAllBirthdayBinding) :
