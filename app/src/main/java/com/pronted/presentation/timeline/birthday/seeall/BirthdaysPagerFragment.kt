...
class BirthdaysPagerFragment : BaseFragment<FragmentBirthdayBinding>() {
    ...
    companion object {
        fun newInstance(page: Int, dayFilter: String): Fragment {
            val fragment = BirthdaysPagerFragment()
            val bundle = Bundle()
    ...
    override fun init() {
        ...
        binding.run {
            ...
            context?.let {
                birthdayAdapter = BirthdaysPagerAdapter(it, tabPosition)
