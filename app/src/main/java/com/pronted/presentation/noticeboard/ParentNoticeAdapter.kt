...
import com.pronted.databinding.RowParentNoticeBinding
...
class ParentNoticeAdapter(
...
) : RecyclerView.Adapter<ParentNoticeAdapter.ChildViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChildViewHolder {
        return ChildViewHolder(
            parent.context,
            RowParentNoticeBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        )
    }
     ...
     * @property binding
     */
    class ChildViewHolder(private val context: Context, val binding: RowParentNoticeBinding) :
