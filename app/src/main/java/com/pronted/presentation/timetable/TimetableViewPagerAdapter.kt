...
class TimetableViewPagerAdapter(@NonNull fragmentActivity: FragmentActivity?,
    ...
    override fun createFragment(position: Int): Fragment {
        val fragment: Fragment = TimetablePagerFragment.newInstance(position, selectedDate)
